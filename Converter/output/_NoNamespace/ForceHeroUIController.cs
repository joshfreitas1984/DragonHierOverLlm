...
public class ForceHeroUIController
{
    ...
    public void ShowForceHeroUI(ForceHeroUIType targetType, ForceData _targetForce)
    {
        ...
        LAB_18077cfe2:
          ...
          if ((*(int *)(lVar7 + 0x380) != this.targetForce.forceID) &&
            ...
            if (*(int *)(lVar7.villageAreaID + 156) == 0) {
              ...
              lVar7 = WorldData.Player(lVar7.villageAreaID,0);
              if (lVar7 == null) throw; // [null/range check failed]
              if (4 < lVar7.forceMeetingStarted) goto LAB_18077d133;
        LAB_18077d1d3:
              if (this.upgradeButton == null) throw; // [null/range check failed]
              GameObject.SetActive(this.upgradeButton,1,0);
              if (this.servantButton == null) throw; // [null/range check failed]
              ...
              if (PlotController.LeftFaceHideOffset == 1) {
                if (((GameController._instance == null) ||
                    (lVar7 = GameController._instance.worldData,
                    lVar7 == null)) || (lVar7 = WorldData.Player(lVar7,0)) == null) throw; // [null/range check failed]
                iVar5 = lVar7.forceMeetingStarted;
                if (*(int *)(pPlotController + 104) <= iVar5) {
                  if ((this.upgradeButton == null) ||
                     (lVar7 = GameObject.GetComponent(this.upgradeButton,DAT_181d9ee60),
        ...
        LAB_18077d133:
            ...
            if (*(int *)(lVar7.villageAreaID + 156) == 1) {
              ...
              lVar7 = WorldData.Player(lVar7.villageAreaID,0);
              if (lVar7 == null) throw; // [null/range check failed]
              if (!lVar7.hour) goto LAB_18077d1d3;
            }
          }
          if (this.upgradeButton == null) throw; // [null/range check failed]
          ...
          do {
            ...
            if (lVar7.cityAreaID <= (int)plVar15) {
              if ((GameController._instance == null) ||
                 ...
                 lVar7 == null)) break;
              if (lVar7.gameMode == 1) {
                lVar7 = *(int64 *)(pPlotController + 0x3a0);
                ...
                if (!cVar3) {
                  if (((this.forceHeroUIPanel != null) &&
                    ...
                    if (((lVar7 != null) && (this.targetForce != null)) &&
                       ((lVar7.infos != null &&
                        (lVar7 = FUN_1817cc780(lVar7.infos,
        ...
        LAB_18077e3b0:
            ...
            if ((((lVar7 == null) || (lVar7.Inns == null)) ||
                (lVar7 = FUN_180002f80(lVar7.Inns,local_res8[0],DAT_181d76758),
    ...
    public void BetrayButtonClicked()
    {
        if (PlotController._instance != null) {
          PlotController.ManagePlayerBetrayForcePlot(PlotController._instance,0)
          ;
          return;
        }
    }
    ...
    public void LeaveButtonClicked()
    {
        if (PlotController._instance != null) {
          PlotController.ManagePlayerLeaveForcePlot
                    (PlotController._instance,this.targetForce,0);
          return;
        }
    }
