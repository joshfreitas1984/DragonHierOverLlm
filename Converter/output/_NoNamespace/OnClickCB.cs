                  ...
                  if (*(uint16 *)(lVar7 + 0x12a) != 0) {
                    do {
                      if (*(int64 *)(*(int64 *)(lVar7 + 176) + (uint64)uVar10 * 16) == lVar8)
                      {
                        ...
                        (*(code *)*puVar5)(plVar3,obj,puVar5[1]);
                        goto LAB_18031a979;
                      }
                      uVar10 = uVar10 + 1;
        ...
        LAB_18031a846:
              ...
              if (!cVar4) {
                ...
                if (!cVar4) {
                  ...
                  FUN_180002970(*(uint16 *)(lVar1 + 72),uVar6,obj);
                }
              }
              else {
                cVar4 = FUN_1800d65c0(lVar1);
                if (!cVar4) {
                  puVar5 = (uint64 *)
                           il2cpp_internal(*(uint64 *)
                                               ...
                                               lVar1);
                  (*(code *)*puVar5)(obj,puVar5);
                }
                else {
                  FUN_180005c70(lVar1,obj);
                }
              }
            }
          }
