...
public class <AsyncWaitForCompletion>d__10
{
    ...
    // ── Methods ──────────────────────────────────────────────────
    // Token : 0x60026DA
    // RVA   : 0x8C74F0   Offset: 0x8C5CF0   Length: 0x1B7
    private virtual void MoveNext()
    {
        ...
        LAB_1808c7572:
            ...
            if ((*(char *)(*(int64 *)(this + 8) + 232) == false) ||
               (cVar1 = TweenExtensions.IsComplete(), cVar1)) goto LAB_1808c7650;
          ...
          *(uint8 *)(this + 10) = local_res18[0];
          FUN_180952070(this + 2,local_res18,this,DAT_181d5d558);
        }
        else {
          if (*(int64 *)(this + 8) == 0) {
                          // WARNING: Subroutine does not return
          ...
          if (*(char *)(*(int64 *)(this + 8) + 232) != false) goto LAB_1808c7572;
