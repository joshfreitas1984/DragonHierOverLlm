    ...
    public virtual void Invoke(UIPanel panel)
    {
            ...
            if (*(char *)(lVar1 + 74) == true) {
              ...
              if (!cVar4) {
                  ...
                  if (*(uint16 *)(lVar7 + 0x12a) != 0) {
                    do {
                      if (*(int64 *)(*(int64 *)(lVar7 + 176) + (uint64)uVar10 * 16) == lVar8)
                      {
                        ...
                        (*(code *)*puVar5)(plVar3,panel,puVar5[1]);
                        goto LAB_18031a979;
                      }
                      uVar10 = uVar10 + 1;
                ...
                if (!cVar4) {
                  ...
                  (*(code *)*puVar5)(plVar3,panel,puVar5);
                }
                else {
                  lVar7 = *plVar3;
                  uVar9 = 0;
        ...
        LAB_18031a846:
              ...
              if (!cVar4) {
                cVar4 = FUN_1800d65c0(lVar1);
                if (!cVar4) {
                  (**(code **)(*panel + 0x138 + (uint64)*(uint16 *)(lVar1 + 72) * 16))
                            (panel,*(uint64 *)
                                      (*panel + 0x140 + (uint64)*(uint16 *)(lVar1 + 72) * 16));
                }
                else {
                  uVar6 = il2cpp_class_get_namespace(lVar1);
                  FUN_180002970(*(uint16 *)(lVar1 + 72),uVar6,panel);
                }
              }
              else {
                cVar4 = FUN_1800d65c0(lVar1);
                if (!cVar4) {
                  puVar5 = (uint64 *)
                           il2cpp_internal(*(uint64 *)
                                               ...
                                               lVar1);
                  (*(code *)*puVar5)(panel,puVar5);
                }
                else {
                  FUN_180005c70(lVar1,panel);
                }
              }
            }
          }
